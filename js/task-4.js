...
let getQuantity = prompt ('Какое количество дроидов хотите заказать?');
const totalPrice = pricePerDroid * getQuantity;
...
if (getQuantity === null)  {
    ...
    alert (`Вы купили ${getQuantity} дроидов, на счету осталось ${balance} кредитов.`)
}
